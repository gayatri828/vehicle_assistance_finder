...
class VehicleServices extends StatefulWidget {
  ...
  @override
  VehicleServicesState createState() => VehicleServicesState();
}

class VehicleServicesState extends State<VehicleServices> {
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset(
            'lib/src/assets/images/service.png', // Path to your image
            height: 70, // Set the height of the image
            width: 70, // Set the width of the image
          ),
          // Space between image and text
          const Text(
            'Vehicle Services', // Text inside the container
            style: TextStyle(
